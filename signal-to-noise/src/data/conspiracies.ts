import { ConspiracyCard } from '../types';

export const CONSPIRACY_DECK: ConspiracyCard[] = [
  // Tier 1 (6 cards)
  {
    id: 'chemtrails',
    name: 'Chemtrails Control Weather',
  ...
  {
    id: 'celebrity_death',
    name: 'Celebrity Death Hoax: Elvis Lives',
  ...
  {
    id: 'crop_circles',
    name: 'Crop Circles Are Alien Messages',
  ...
  {
    id: 'bigfoot',
    name: 'Bigfoot Sighting Cover-Up',
  ...
  {
    id: 'subliminal_ads',
    name: 'Subliminal Advertising in Music',
  ...
  {
    id: 'pharma_coverup',
    name: 'Pharmaceutical Company Hides Cure',
  ...
  {
    id: 'election_rigging',
    name: 'Election Rigging Software',
  ...
  {
    id: 'weather_machine',
    name: 'Government Weather Machine',
  ...
  // Tier 3 (2 cards)
  {
    id: 'mayor_embezzlement',
    name: 'Mayor Embezzling City Funds',
  ...
  {
    id: 'tech_data_sale',
    name: 'Tech Company Selling User Data',
