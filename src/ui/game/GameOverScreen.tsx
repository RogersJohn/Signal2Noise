...
const styles: Record<string, React.CSSProperties> = {
  ...
  sectionTitle: { color: '#888', fontSize: '12px', margin: '0 0 12px', textTransform: 'uppercase' as const },
  rankRow: { display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px', fontSize: '13px' },
  medal: { fontSize: '18px', width: '24px' },
  rankName: { color: '#fff', flex: 1 },
  rankScore: { color: '#fa0', width: '60px' },
  rankCred: { color: '#0af', width: '60px', fontSize: '11px' },
  rankStrategy: { color: '#555', fontSize: '10px' },
  playAgain: {
