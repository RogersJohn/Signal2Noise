...
const styles: Record<string, React.CSSProperties> = {
  ...
  card: {
    ...
    textAlign: 'left', fontFamily: 'monospace', color: '#d1d5db', fontSize: '13px',
    transition: 'opacity 0.2s, border-color 0.2s',
  },
  highlighted: { border: '2px solid #0f0', background: '#1a2a1a' },
  dimmed: { opacity: 0.45 },
  icon: { fontSize: '24px', marginBottom: '4px' },
  name: { fontWeight: 'bold', color: '#fff', fontSize: '14px', marginBottom: '3px' },
  description: { color: '#9ca3af', fontSize: '12px', marginBottom: '6px', lineHeight: '1.3' },
  evidenceSection: { marginTop: '4px', display: 'flex', flexWrap: 'wrap', gap: '6px' },
  evidenceBadge: { fontSize: '11px', background: '#111', padding: '2px 4px', borderRadius: '2px' },
  broadcastSection: { marginTop: '4px', display: 'flex', flexWrap: 'wrap', gap: '6px' },
  broadcastBadge: { fontSize: '11px', padding: '2px 4px' },
  assignLabel: { color: '#0f0', fontSize: '11px', textAlign: 'center', marginTop: '4px' },
};
