...
const styles: Record<string, React.CSSProperties> = {
  ...
  header: { color: '#0f0', fontSize: '16px', fontWeight: 'bold', textAlign: 'center', marginBottom: '8px' },
  divider: { borderTop: '1px solid #333', margin: '12px 0' },
  entry: { marginBottom: '16px', paddingLeft: '8px' },
  flavorText: { color: '#ccc', fontSize: '12px', fontStyle: 'italic', marginBottom: '4px' },
  evidenceLine: { color: '#888', fontSize: '11px' },
  hint: { color: '#666', fontSize: '11px', textAlign: 'center', fontStyle: 'italic', marginBottom: '12px' },
  dismissBtn: {
    display: 'block',
    margin: '0 auto',
    background: '#0a3d0a',
